...
import com.multi.gazee.service.ChargeService;
import com.multi.gazee.service.CustomerServiceService;
import com.multi.gazee.service.MemberService;
...
import com.multi.gazee.service.SetService;
import com.multi.gazee.service.WithdrawService;
...
public class AdminController {
    ...
    public String loadMember(AdminPageVO pageVo, @RequestParam("pageNumber") int pageNumber, Model model) throws Exception {
    ...
    public String loadProduct(AdminPageVO pageVo, @RequestParam("pageNumber") int pageNumber, Model model) throws Exception {
    ...
    public String loadCs(AdminPageVO pageVo, @RequestParam("pageNumber") int pageNumber, Model model) throws Exception {
        return adminSidebarService.loadCs(pageVo, pageNumber, model);
    }
    
    @RequestMapping(value = "report.do")
    public String loadReport(AdminPageVO pageVo, @RequestParam("pageNumber") int pageNumber, Model model) throws Exception {
    ...
    public String loadMemberList(AdminPageVO pageVo, Model model) throws Exception {
    ...
    public String loadCsList(AdminPageVO pageVo, @RequestParam("pageNumber") int pageNumber, Model model) throws Exception {
    ...
    public String loadReportList(AdminPageVO pageVo, @RequestParam("pageNumber") int pageNumber, Model model) throws Exception {
    ...
    public String report_one(@ModelAttribute("reportId") int id, Model model) throws Exception {
        return reportService.adminReportOne(id, model);
    }
